...
<div class="hero-section">
  <div class="hero-content">
    <h1 class="hero-title">Anne Arundel County Housing Cost Calculator</h1>
    <p class="hero-subtitle">Estimate Your Housing Budget by Town</p>
    ...
    <div class="hero-cta">
      ...
      <a href="#town-breakdown" class="btn btn-secondary">Town Breakdown</a>
      ...
      <div class="calculator-form">
        ...
        <div class="form-group">
          ...
          <select id="town-select">
            ...
            <option value="brooklandville">Brookland</option>
...
<div id="town-breakdown" class="section">
  <div class="container">
    ...
    <div class="resources-section">
      ...
      <ul>
        <li><a href="/neighborhoods-relocation-guide/" class="btn">Anne Arundel County Neighborhood & Relocation Guide</a></li>
        <li><a href="/housing-guide/" class="btn btn-secondary">View Full Housing Guide</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div id="budgeting" class="section">
  <div class="container">
    ...
    <div class="resources-section">
      ...
      <ul>
        <li><a href="/budgeting-cost-living-guide/" class="btn">Anne Arundel County Budgeting & Cost of Living Guide</a></li>
...
<div class="section">
  <div class="container">
    ...
    <div class="resources-section">
      ...
      <ul>
        <li><a href="/va-benefits-military-resources/" class="btn">VA Benefits & Military Resources</a></li>
...
document.getElementById('calculate-btn').addEventListener('click', function() {
  ...
  const loanTerm = 30;
  const loanAmount = monthlyPayment * 1000 * 0.7; // Estimate based on payment
  ...
  if (housingType === 'buy') {
    ...
    recommendations.push('<p>💡 Check <a href="/va-benefits-military-resources/">VA benefits</a> if eligible - may reduce or eliminate down payment requirements.</p>');
    recommendations.push('<p>💡 Explore <a href="/budgeting-cost-living-guide/">first-time buyer programs</a> for down payment assistance.</p>');
  } else {
